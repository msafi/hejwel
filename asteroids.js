...
function init() {
  ...
  var manifest = [
    {id: "begin", src: "mobile-graphic-easel-examples-assets-Game-Spawn.mp3|../../mobile-graphic-easel-examples-assets-Game-Spawn.ogg"},
    {id: "break", src: "mobile-graphic-easel-examples-assets-Game-Break.mp3|../../mobile-graphic-easel-examples-assets-Game-Break.ogg", data: 6},
    {id: "death", src: "mobile-graphic-easel-examples-assets-Game-Death.mp3|../../mobile-graphic-easel-examples-assets-Game-Death.ogg"},
    {id: "laser", src: "mobile-graphic-easel-examples-assets-Game-Shot.mp3|../../mobile-graphic-easel-examples-assets-Game-Shot.ogg", data: 6},
    {id: "music", src: "mobile-graphic-easel-examples-assets-18-machinae_supremacy-lord_krutors_dominion.mp3|../../mobile-graphic-easel-examples-assets-18-machinae_supremacy-lord_krutors_dominion.ogg"}
  ];
